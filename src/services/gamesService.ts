...
export const WHAT_IS_SEISMIC_QUESTIONS: Question[] = [
  {
    ...
    option_d: 'Cambia bruscamente la temperatura ambiental',
    correct_option: 'b',
  ...
  },
  {
    ...
    option_b: 'La Magnitud mide la energía liberada (única) y la Intensidad mide los efectos y daños en cada lugar',
    option_c: 'La Magnitud mide los heridos y la Intensidad la profundidad',
  ...
  },
  {
    ...
    option_a: 'Ondas Superficiales Rayleigh',
    option_b: 'Ondas Primarias o Longitudinales (Ondas P)',
  ...
  },
  {
    ...
    option_b: 'Por la cercanía a fallas activas y el contacto directo con la placa de Nazca subducida horizontalmente',
    option_c: 'Por el clima seco y las altas temperaturas de verano',
    option_d: 'Por la altitud sobre el nivel del mar',
    correct_option: 'b',
  ...
  },
  {
    ...
    option_b: 'Confinar las paredes de ladrillo para que trabajen como un bloque monolítico ante fuerzas laterales',
    option_c: 'Sostener únicamente el peso vertical del techo',
  ...
  },
  {
    ...
    option_b: 'Porque pueden percibir las ondas P de baja amplitud que viajan más rápido que las ondas destructivas S',
    option_c: 'Porque huelen los gases del centro de la Tierra',
    option_d: 'Es una leyenda urbana sin explicación física',
    correct_option: 'b',
...
export const EMERGENCY_KIT_ITEMS: EmergencyKitItem[] = [
  ...
  { id: 'console', name: 'Consola portátil de juegos', icon: '🎮', isEssential: false, category: 'no-essential', reason: 'Es pesada, frágil e innecesaria para la supervivencia básica.' },
